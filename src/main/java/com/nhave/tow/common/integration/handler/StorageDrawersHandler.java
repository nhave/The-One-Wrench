...
public class StorageDrawersHandler extends WrenchHandler
{
	...
	public boolean shouldDenyBlockActivate(WrenchMode mode, EntityPlayer player, World world, BlockPos pos)
	{
		...
		return ((mode != ModItems.modeNone && (block instanceof BlockDrawers || block instanceof BlockController)) || (mode == ModItems.modeWrench && (block instanceof BlockKeyButton || block instanceof BlockFramingTable) && player.isSneaking()));
	}
}
