...
public class ForestryHandler extends WrenchHandler
{
	...
	public EnumActionResult onWrenchUseFirst(WrenchMode mode, EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ, EnumHand hand)
	{
	    ...
	    boolean core = ModuleHelper.isEnabled("core") && ModuleCore.getBlocks() != null;
	    boolean factory = ModuleHelper.isEnabled("factory") && ModuleFactory.getBlocks() != null;
	    boolean apiculture = ModuleHelper.isEnabled("apiculture") && ModuleApiculture.getBlocks() != null;
	    boolean arboriculture = ModuleHelper.isEnabled("arboriculture") && ModuleArboriculture.getBlocks() != null;
	    boolean lepidopterology = ModuleHelper.isEnabled("lepidopterology") && ModuleLepidopterology.getBlocks() != null;
